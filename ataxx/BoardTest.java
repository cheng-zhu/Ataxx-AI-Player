...
public class BoardTest {
    ...
    public void testPass() {
        ...
        b.setBlock('d', '3');
        b.setBlock('d', '4');
        makeMoves(b, PASSMOVES);
        checkBoard(b, BLUENEEDSTOPASS);
        b.makeMove("-");
    }
    ...
    private static final String[] PASSMOVES = {
        "a7-b7", "a1-c1",
        "b7-c7", "c1-b1",
        "c7-d7", "c1-d1",
        "d7-f7", "d1-e1",
    ...
    private static final PieceColor[][] BLUENEEDSTOPASS = {
            {RED, RED, RED, RED, EMPTY, RED, RED},
